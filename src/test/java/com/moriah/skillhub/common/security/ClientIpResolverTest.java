...
class ClientIpResolverTest {
    ...
    void untrustedRemoteAddr_ignoresForwardedForHeader_returnsRemoteAddr() {
        ...
        ClientIpResolver resolver = new ClientIpResolver(new TrustedProxyProperties(List.of()));
    ...
    void trustedRemoteAddr_withForwardedForHeader_returnsLeftmostClientIp() {
        ClientIpResolver resolver = new ClientIpResolver(new TrustedProxyProperties(List.of("10.0.0.5")));
