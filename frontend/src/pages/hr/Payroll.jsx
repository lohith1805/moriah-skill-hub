        ...
        {viewingSlip && (
          <div className="p-5 bg-white rounded-xl border border-border text-left font-sans flex flex-col gap-4">
            ...
            <div className="text-xs bg-cream-50/70 p-3 rounded-lg border border-border">
              ...
              {viewingSlip.lopDays > 0 && (
                <p className="mt-1"><span className="text-ink-500">Loss of pay:</span> {viewingSlip.lopDays} working day(s) not present / not on paid leave — base salary prorated</p>
              )}
            </div>
            <div className="flex flex-col gap-1.5 text-sm">
              <div className="flex justify-between"><span className="text-ink-600">Gross{viewingSlip.lopDays > 0 ? " (after LOP)" : ""}</span><span className="font-medium">{CURRENCY(viewingSlip.gross)}</span></div>
