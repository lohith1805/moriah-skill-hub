...
export const NAV_CONFIG = {
  [ROLES.STUDENT]: [
    ...
    { to: "/student/challenges", label: "Bug Challenges", icon: Bug },
  ...
  [ROLES.TRAINER]: [
    ...
    { to: "/trainer/payslips", label: "My Payslips", icon: Wallet },
  ...
  [ROLES.DEVELOPER]: [
    ...
    { to: "/developer/pre-project-discussions", label: "Client Pre-Project Discussions", icon: CalendarClock },
    ...
    { to: "/developer/payslips", label: "My Payslips", icon: Wallet },
  ...
  [ROLES.LEAD_GENERATOR]: [
    ...
    { to: "/leads/payslips", label: "My Payslips", icon: Wallet },
  ...
  [ROLES.HR]: [
    ...
    { to: "/hr/payslips", label: "My Payslips", icon: Wallet },
  ...
  [ROLES.BUSINESS_ANALYST]: [
    ...
    { to: "/ba/payslips", label: "My Payslips", icon: Wallet },
  ...
  [ROLES.ADMIN]: [
    ...
    { to: "/admin/pre-project-discussions", label: "Client Pre-Project Discussions", icon: CalendarClock },
