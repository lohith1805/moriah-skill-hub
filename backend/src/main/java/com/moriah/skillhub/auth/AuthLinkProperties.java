...
/**
 * Frontend routes for the links {@code AuthService} emails out — a {@code {token}} placeholder,
 * substituted with the raw (unhashed) token. Same per-purpose full-URL treatment as
