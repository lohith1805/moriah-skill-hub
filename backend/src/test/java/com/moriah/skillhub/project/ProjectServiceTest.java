...
class ProjectServiceTest {
    ...
    void update_draftProject_editsInPlaceNullPreservingOmittedFields() {
        ...
        UpdateProjectRequest request = new UpdateProjectRequest("New Title", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void update_publishedProjectWithVersion_createsNewDraftAndArchivesOld() {
        ...
        UpdateProjectRequest request = new UpdateProjectRequest(null, null, null, null, null, null, null, null, null, null, null, null, null, "v2");
        ProjectResponse response = projectService.update(1L, 10L, request);
    ...
    private com.moriah.skillhub.project.dto.CreateProjectRequest createRequest(String title) {
        return new com.moriah.skillhub.project.dto.CreateProjectRequest(
                title, "A weather app", List.of("React", "Node"), null, "web", null, null, null, null, null, null, null, null, null);
    }

    private UpdateProjectRequest updateRequest() {
        return new UpdateProjectRequest(null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    }
